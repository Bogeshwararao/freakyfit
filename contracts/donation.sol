...
contract DonorContract {
    ...
    function setDonors(string memory _fullname, uint _age, string memory _medical_id,
                       string memory _blood_type, string[] memory _organ)
    public
    {
    ...
    function setPatients(string memory _fullname, uint _age, string memory _medical_id,
                       string memory _blood_type, string[] memory _organ)
    public
    {
        require ( keccak256(abi.encodePacked((donorMap[_medical_id].medical_id))) != keccak256(abi.encodePacked(_medical_id)));
    ...
    function getDonor(string memory _medical_id) view public returns(string memory, uint, string memory, string[] memory)
    {
        return
        (
    ...
    function getPatient(string memory _medical_id) view public returns(string memory, uint, string memory, string[] memory)
    {
        return
        (
